...
<div style="font-family:arial;color:#000;position:relative;max-width:600px;margin:auto;padding:15px;">
  <h2 style="padding-left:10px;padding-right:10px;">Advisor Join Request</h2>
  ...
  <h5 style="font-weight:initial;padding-left:10px;padding-right:10px;">Check database for further information.</h5>
