...
<div style="font-family:arial;color:#000;position:relative;max-width:600px;margin:auto;padding:15px;">
  ...
  <h4 style="font-weight:initial;border-top:1px solid #e3e3e3;padding-top:15px;padding-left:10px;padding-right:10px;">Please click the link below to register for online access to the Fadvi directory.</h4>
  <h4 style="font-weight:initial;padding-left:10px;padding-right:10px;"><a href="{{ route('advisor.register.key.get', ['key' => $randomKey]) }}">Register Your Account</a></h4>
