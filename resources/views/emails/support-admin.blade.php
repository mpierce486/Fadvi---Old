...
<div style="font-family:arial;color:#000;position:relative;max-width:600px;margin:auto;padding:15px;">
  ...
  <h4 style="font-weight:initial;border-top:1px solid #e3e3e3;padding-top:15px;padding-left:10px;padding-right:10px;">A registered user has submitted a support request. Details below.</h4>
  <h4 style="font-weight:initial;padding-left:10px;padding-right:10px;">First Name: {{ $user->first_name }}</h4>
  <h4 style="font-weight:initial;padding-left:10px;padding-right:10px;">Email: {{ $user->email }}</h4>
